...
export const metadata = {
  title: "Checkout | HookSignals Studio",
  description: "Start your HookSignals Studio subscription.",
};

export default function StudioCheckoutPage() {
  const url = process.env.NEXT_PUBLIC_PADDLE_STUDIO_CHECKOUT_URL;
  ...
  return (
    <main className="min-h-screen bg-[#030507] px-5 py-20 text-white md:px-8">
      <div className="mx-auto max-w-3xl rounded-[32px] border border-white/10 bg-white/[0.03] p-8 md:p-12">
        ...
        <h1 className="mt-5 text-5xl font-black tracking-tight">Studio payment is not connected on this deployment.</h1>
