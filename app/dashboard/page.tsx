...
export default async function DashboardPage() {
  const data = await getDashboardPreviewData();
  const plan = data.subscription?.plan || 'No active plan';
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-[28px] border border-white/10 bg-black/25 p-6">
            ...
            <p className="mt-3 leading-7 text-white/50">Live credit data from Supabase.</p>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-black/25 p-6">
            ...
            <p className="mt-3 leading-7 text-white/50">Subscription persistence is being wired through webhook sync.</p>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-[32px] border border-white/10 bg-white/[0.03] p-7 md:p-10">
          ...
          <p className="mt-4 max-w-3xl leading-8 text-white/55">
            Premium gating will use the plan and credit state stored in Supabase.
          </p>
