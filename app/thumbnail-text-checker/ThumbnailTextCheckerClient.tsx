...
export default function ThumbnailTextCheckerClient() {
  ...
  return (
    <PremiumToolShell badge="Thumbnail checker" title="Check if your thumbnail text will stop the scroll." description="Paste your thumbnail text. Find out if it is short enough, readable at phone-feed size, and specific enough to create click intent — before you design." primaryHref="/youtube-title-analyzer" primaryLabel="Score Your Title" secondaryHref="/tools" secondaryLabel="All Tools">
