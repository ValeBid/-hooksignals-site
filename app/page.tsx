  ...
  return (
    <main className="min-h-screen bg-[#070708] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,#064e3b_0%,transparent_32%),radial-gradient(circle_at_85%_10%,#1f2937_0%,transparent_34%)] opacity-80" />
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-6">
          <nav className="flex items-center justify-between">
            ...
            <div className="hidden items-center gap-6 text-sm text-white/50 md:flex">
              ...
              <a href="/hook-psychology">Hook Psychology</a>
              <a href="/youtube-ctr-tips">CTR Tips</a>
            </div>
          ...
          <div className="grid gap-12 pb-20 pt-20 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <div className="mt-10 grid gap-3 sm:grid-cols-2">
                {workflow.map((step, index) => (
                  <div
                    key={step}
                    className="rounded-2xl border border-white/10 bg-black/30 p-4 text-sm text-white/60"
                  >
            ...
            <div className="rounded-[36px] border border-white/10 bg-black/40 p-5 shadow-2xl shadow-emerald-950/20">
              <div className="rounded-[28px] border border-white/10 bg-[#09090a] p-5">
                <div className="mb-5 flex items-center justify-between">
                  <div>
                    <p className="text-sm text-white/40">Hook signal preview</p>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/[0.035] p-5">
                  <p className="text-sm text-white/40">Input</p>
