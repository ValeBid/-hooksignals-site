          ...
          <div className="relative mx-auto max-w-[1480px] px-5 py-5 md:px-8 hs-mobile-cinematic">
              ...
              <div>
                ...
                <div className="mt-10 grid gap-3 sm:grid-cols-2 xl:grid-cols-4 hs-slide-up hs-delay-4">
                  {productTools.map(([name, desc, href, icon]) => (
                    <a key={href} href={href} className="group rounded-[22px] border border-white/10 bg-white/[0.04] p-4 backdrop-blur-xl transition hover:border-cyan-300/30 hover:bg-white/[0.08] hover:-translate-y-1 hs-mobile-card">
            ...
            <section className="mt-14 grid gap-4 md:grid-cols-3">
              {authority.map(([title, desc], index) => (
                <div key={title} className={`rounded-[30px] border border-white/10 bg-white/[0.04] p-7 shadow-[0_20px_60px_rgba(0,0,0,.35)] backdrop-blur-xl hs-slide-up hs-delay-${index + 1} hs-mobile-card`}>
                  <LogoMark />
            ...
            <section className="mt-14 rounded-[34px] border border-cyan-300/10 bg-gradient-to-br from-cyan-400/[0.05] via-black/40 to-violet-500/[0.05] p-8 shadow-[0_30px_100px_rgba(0,0,0,.45)] hs-mobile-card">
              ...
              <div className="mt-10 grid gap-4 lg:grid-cols-2">
                {comparison.map(([title, desc]) => (
                  <div key={title} className="rounded-[28px] border border-white/10 bg-black/25 p-7 backdrop-blur-xl hs-mobile-card">
            ...
            <section className="py-20 md:py-24">
              <div className="rounded-[36px] border border-cyan-300/20 bg-gradient-to-br from-cyan-400/[0.08] via-sky-400/[0.04] to-violet-500/[0.08] p-8 shadow-[0_40px_120px_rgba(0,0,0,.45)] hs-mobile-card">
                ...
                <p className="mt-6 max-w-3xl text-lg leading-8 text-white/58 hs-mobile-text">Use HookSignals to optimize hooks, titles, scripts and thumbnails before publishing. Build stronger retention systems and improve creator packaging quality across YouTube Shorts and TikTok.</p>
