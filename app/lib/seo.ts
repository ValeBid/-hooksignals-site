export const siteConfig = {
  ...
  description:
    "AI-powered creator workflow tools for improving hooks, titles, thumbnails, Shorts scripts and retention before publishing.",
};
...
export const seoRoutes: SeoRoute[] = [
  {
    ...
    description:
      "Analyze hooks, improve titles, generate Shorts scripts and check creator packaging before publishing.",
    priority: 1,
  ...
  },
  {
    ...
    description:
      "Explore HookSignals tools for hooks, titles, scripts, thumbnails and viewer retention.",
    priority: 0.92,
  ...
  {
    path: "/hook-analyzer",
    title: "Hook Analyzer | Score Your Video Hook | HookSignals",
    description:
      "Score your YouTube, TikTok or Shorts hook for clarity, curiosity and retention risk before publishing.",
    priority: 0.95,
    changeFrequency: "weekly",
    intent: "tool",
  },
  {
    path: "/hook-improver",
    title: "Hook Improver | Rewrite Weak Hooks | HookSignals",
    description:
      "Rewrite weak video hooks into clearer, sharper and more retention-focused opening lines.",
    priority: 0.9,
    changeFrequency: "weekly",
    intent: "tool",
  },
  {
    ...
    description:
      "Generate stronger YouTube hooks for Shorts, long-form videos and creator content.",
    priority: 0.88,
    changeFrequency: "weekly",
    intent: "tool",
  },
  ...
  },
  {
    ...
    description:
      "Generate YouTube title ideas built around clarity, curiosity and click intent.",
    priority: 0.88,
    changeFrequency: "weekly",
    intent: "tool",
  },
  {
    path: "/shorts-script-generator",
    title: "Shorts Script Generator | AI Short-Form Script Tool | HookSignals",
    description:
      "Generate short-form script structures designed for hook strength, pacing and retention.",
    priority: 0.88,
    changeFrequency: "weekly",
    intent: "tool",
  },
  {
    path: "/thumbnail-text-checker",
    title: "Thumbnail Text Checker | Improve CTR Clarity | HookSignals",
    description:
      "Check whether your thumbnail text is readable, clear and built for stronger click intent.",
    priority: 0.84,
    changeFrequency: "weekly",
    intent: "tool",
  },
  ...
  },
  {
    ...
    title: "Viral Hook Examples | HookSignals",
    description:
      "Study viral hook examples and reusable opening patterns for short-form videos.",
    priority: 0.8,
    changeFrequency: "weekly",
    intent: "examples",
  },
  {
    path: "/youtube-hook-examples",
    title: "YouTube Hook Examples | HookSignals",
    description:
      "Browse YouTube hook examples for Shorts, creator videos and retention-focused openings.",
    priority: 0.78,
    changeFrequency: "weekly",
    intent: "examples",
  },
  {
    path: "/hook-formulas",
    title: "Hook Formulas for Short-Form Videos | HookSignals",
    description:
      "Use proven hook formulas to create clearer, more curiosity-driven video openings.",
    priority: 0.78,
    changeFrequency: "weekly",
    intent: "education",
  },
