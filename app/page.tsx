    ...
    <main className="min-h-screen bg-[#070708] text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-6">
          ...
          <div className="mx-auto max-w-4xl pb-20 pt-24 text-center">
            ...
            <p className="mt-4 text-sm text-white/40">
              Join creators testing AI hook, title and retention tools before
              public launch.
            </p>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
        <div className="rounded-[32px] border border-white/10 bg-white/[0.04] p-8 md:p-12">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-white/55">
            ...
            pages, related workflows and internal links that grow into a search
            asset over time.
          </p>
        </div>
      </section>
      ...
      <footer className="mx-auto max-w-7xl px-6 pb-10 text-sm text-white/40">
        <div className="border-t border-white/10 pt-8">
          ...
          <p className="mt-6">
            HookSignals helps creators test hooks, titles and content signals
            before publishing.
          </p>
        </div>
      </footer>
